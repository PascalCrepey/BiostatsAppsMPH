...
golem::fill_desc(
  ...
  author_email = "pascal.crepey@ehesp.fr",      # Your Email
...
golem::set_golem_wd("/Users/pascalcrepey/Google Drive/0-Enseignement/MPH2/BiostatApps")

## 1.2 - Set common Files 
## 
## If you want to use the MIT licence, README, code of conduct, lifecycle badge, and news

usethis::use_mit_license( name = "Pascal Crépey" )  # You can set another licence here
